...
export default function NavBar({ selectedYear, setSelectedYear, years, onAddNote, onShowCarousel }) {
    return (
        <div
            className="fixed top-0 w-full z-10 px-6 py-3 pb-8 sm:pb-8"
            style={{
        ...
        >
            ...
            <div className="hidden sm:flex items-center justify-between">
                <h1 className="font-['Acme',sans-serif] text-4xl text-gray-900">
            ...
            <div className="sm:hidden flex flex-col items-center gap-2">
                <div className="flex items-center justify-between w-full">
                    <h1 className="font-['Acme',sans-serif] text-2xl text-gray-900">
                        Mac 'n' Cheese for Tanya
                    </h1>
                    <button
                        onClick={onShowCarousel}
                        className="bg-orange-700 hover:bg-orange-600 text-white p-2 rounded-lg shadow-sm transition-colors"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C9.24 2 7 4.24 7 7v4.17l-2 2V15h14v-1.83l-2-2V7c0-2.76-2.24-5-5-5zm0 20c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-8.83V7c0-3.08-2.17-5.64-5-6.32V0h-2v.68C7.17 1.36 5 3.92 5 7v6.17L3 15.17V17h18v-1.83l-3-2z"/></svg>
                    </button>
                </div>
                <div className="flex items-center gap-3">
                    <div className="relative">
                    ...
                    <button
                        onClick={onAddNote}
                        className="bg-gray-900 hover:bg-gray-800 text-white px-3 py-1.5 rounded-lg text-xs font-medium shadow-sm transition-colors"
                    >
                        + Add note
                    </button>
                </div>
